...
export const FrontEndDescription =
  "I created a small 'theme' in accordance with the Material-UI assumptions and styled the elements that I use in the project globally. Everything is based on 'JSS' and hooked up to components. Additionally, I added responsiveness for mobile devices.";
